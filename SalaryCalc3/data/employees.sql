...
(
    ...
    CONSTRAINT unique_pos_entry UNIQUE (employee_id, department_id)
);
...
(
    ...
    FOREIGN KEY(position) REFERENCES department(id),
    CONSTRAINT pos_date_unique UNIQUE(position, change_date)
);

INSERT INTO base_rate_history VALUES (1, 50.00,  '2011-02-01');
INSERT INTO base_rate_history VALUES (2, 60.00,  '2011-02-01');
INSERT INTO base_rate_history VALUES (3, 70.00,  '2011-02-01');

/* Update */
INSERT INTO base_rate_history VALUES (1, 80.00,  '2012-02-01');
INSERT INTO base_rate_history VALUES (2, 90.00,  '2012-02-01');
INSERT INTO base_rate_history VALUES (3, 100.00, '2012-02-01');

/*Next update */
INSERT INTO base_rate_history VALUES (1, 110.00, '2013-02-01');
INSERT INTO base_rate_history VALUES (2, 120.00, '2013-02-01');
INSERT INTO base_rate_history VALUES (3, 130.00, '2013-02-01');
COMMIT;
